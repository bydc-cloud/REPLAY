...
function AppContent() {
  ...
  return (
    <div className="flex h-screen bg-[var(--replay-black)] relative">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto overflow-x-hidden pb-36 md:pb-28 pt-[68px] md:pt-0 relative scroll-smooth" style={{ WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain' }}>

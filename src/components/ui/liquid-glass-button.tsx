...
function LiquidButton({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn("relative overflow-hidden rounded-full", liquidbuttonVariants({ variant, size, className }))}
      {...props}
    >
      <div
      ...
      <div className="pointer-events-none z-10 px-4">{children}</div>
      <GlassFilter />
    </Comp>
  );
}

...
export const QuickAccessCard = ({ icon: Icon, title, description }: QuickAccessCardProps) => {
  return (
    <div className="w-full bg-[var(--replay-elevated)] p-5 md:p-6 rounded-xl border border-[var(--replay-border)] hover:border-[var(--replay-off-white)] transition-all hover-lift group">
      <div className="bg-[var(--replay-dark-grey)] p-3 md:p-4 rounded-lg group-hover:bg-[var(--replay-border)] transition-colors inline-block">
